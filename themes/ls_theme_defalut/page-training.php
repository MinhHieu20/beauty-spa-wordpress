...
?>
    <div class="container-max">
        ...
        <div class="container content training-container">
            <div class="content-img">
                <img src="<?php bloginfo('template_directory'); ?>/images/butterfly-wings.png" alt="">
            </div>
            <div class="content-title">
                <h1>CÁC KHÓA ĐÀO TẠO</h1>
            </div>
            <div class="row content-product content-product-training">
                ...
                <div class="col-lg-3 col-6 pd-05">
                    <a href="./training-detail.html">
                        <div class="content-product-training__image">
                            <img class="content-product-image" src="<?php bloginfo('template_directory'); ?>/images/subject_training/8.png" alt="">
                        </div>
                        <div class="content-product-courses">
                            <img class="content-product-courses__icon" src="<?php bloginfo('template_directory'); ?>/images/icon/icon-09.png" alt="">
                            <p class="content-product-courses__text">KHÓA ĐÀO TẠO ĐIỀU TRỊ THÂM MỤN</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-6 pd-05">
                    <a href="./training-detail.html">
                        <div class="content-product-training__image">
                            <img class="content-product-image" src="<?php bloginfo('template_directory'); ?>/images/subject_training/9.png" alt="">
                        </div>
                        <div class="content-product-courses">
                            <img class="content-product-courses__icon" src="<?php bloginfo('template_directory'); ?>/images/icon/icon-07.png" alt="">
                            <p class="content-product-courses__text">KHÓA ĐÀO TẠO CHĂM SÓC DA</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="container-body container-body-training">
                <div class="container-service row">
                    <div class="container-service-item col-xl-3 col-6">
                        <img src="<?php bloginfo('template_directory'); ?>/images/dieutrimun.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/dieutrithammun.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/chamsocda.png" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/goidau.jpg" alt="" class="service-image">

                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/trietlong.jpg" alt="" class="service-image">

                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/tamtrang.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-xl-3 col-6 pd-05">
                        <img src="<?php bloginfo('template_directory'); ?>/images/massage-da-nong.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-xl-3 col-6">
                        <img src="<?php bloginfo('template_directory'); ?>/images/xamthammy.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-lg-3 col-6">
                        <img src="<?php bloginfo('template_directory'); ?>/images/dieutrithammun.jpg" alt="" class="service-image">
                    </div>
                    <div class="container-service-item col-lg-3 col-6">
                        <img src="<?php bloginfo('template_directory'); ?>/images/chamsocda.png" alt="" class="service-image">
    ...
    <!-- advise-contact -->
    <div class="advise-contact advise-contact-training">
    ...
    <div class="address address-training">
