    ...
    <div class="content">
        <div class="beautify-container grid wide dp-none dp-blockPC">
            <div class="beautify row">
                <div class="beautify-program col l-9 col-md-9">
                    <div class="beautify-program-list row">
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            ...
                            <div class="beautify-program-list__item--text">
                                <h2 class="beautify-program-list__item--text--title">Khai trương SHYNH spa chi nhánh
                                    quận 2</h2>
                                <p class="beautify-program-list__item--text--desc">Cơ sở mới của SHYNH SPA được mở
                                    rộng hoàn toàn mới tại địa chỉ mới
                                    ...</p>
                            </div>
                        ...
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            <a href="./tips-beautify-detail.html">
                                <div class="beautify-program-list__item--image image-pseudo--tips">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/event/event2.png" alt=""
                                         class="beautify-program-list__item--image--product">
                                </div>
                                <div class="beautify-program-list__item--text">
                                    <h2 class="beautify-program-list__item--text--title">Ngày của mẹ-Tặng mẹ combo tận
                                        hưởng 699k</h2>
                                    <p class="beautify-program-list__item--text--desc">Cảm ơn mẹ đã luôn hy sinh, lo
                                        lắng cho con suốt những năm tháng qua ...</p>
                        ...
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            <a href="./tips-beautify-detail.html">
                                ...
                                <div class="beautify-program-list__item--text">
                                    <h2 class="beautify-program-list__item--text--title">ĐĂNG KÝ THÀNH VIÊN VIP CƠ HỘI
                                        TRÚNG XE SH</h2>
                                    <p class="beautify-program-list__item--text--desc">Đăng ký thành viên để tận hưởng
                                        những ưu đãi đồng thời có cơ hội
                                        ....</p>
                        ...
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            <div class="beautify-program-list__item--image image-pseudo--tips">
                                <img src="<?php bloginfo('template_directory'); ?>/images/event/event4.png" alt=""
                                     class="beautify-program-list__item--image--product">
                            </div>
                            <div class="beautify-program-list__item--text">
                                <h2 class="beautify-program-list__item--text--title">10 cách làm đẹp tại nhà hiệu
                                    quả</h2>
                                <p class="beautify-program-list__item--text--desc">10 cách chăm sóc da hiệu quả tại
                                    nhà hiệu quả được các y bác sĩ có nhiều kinh nghiệm ...
                                    ...</p>
                        ...
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            <div class="beautify-program-list__item--image image-pseudo--tips">
                                <img src="<?php bloginfo('template_directory'); ?>/images/event/event5.png" alt=""
                                     class="beautify-program-list__item--image--product">
                            </div>
                            <div class="beautify-program-list__item--text">
                                <h2 class="beautify-program-list__item--text--title">bí quyết chọn mỹ phẩm phù hợp
                                    với da dầu mụn</h2>
                                <p class="beautify-program-list__item--text--desc">Da dầu mụn được coi là loại da
                                    kén mỹ phẩm nhất,vì vậy để lựa chọn đồ
                                    ...</p>
                        ...
                        <div class="beautify-program-list__item col-lg-4 col-md-4">
                            <div class="beautify-program-list__item--image ">
                                <img src="<?php bloginfo('template_directory'); ?>/images/event/event6.png" alt=""
                                     class="beautify-program-list__item--image--product">
                            </div>
                            <div class="beautify-program-list__item--text">
                                <h2 class="beautify-program-list__item--text--title">top 5 thực phẩm khiến da nhanh
                                    lão hóa</h2>
                                <p class="beautify-program-list__item--text--desc">Top 5 loại thực phẩm siêu hấp dẫn
                                    chúng ta nhưng lại khiến cho làn da lão hóa nhanh chóng
                                    ...</p>
                    ...
                    <div class="product-pagination">
                        <ul class="product-pagination-list d-flex">
                            <div class="product-pagination-prev"></div>
                            <li class="product-pagination-list__item active-white">
                                <a href="" class="product-pagination-list__item--link">1</a>
                            </li>
                            <li class="product-pagination-list__item">
                                <a href="" class="product-pagination-list__item--link">2</a>
                            </li>
                            <li class="product-pagination-list__item">
                                <a href="" class="product-pagination-list__item--link">3</a>
                            </li>
                ...
                <div class="beautify--program col l-3 col-md-3">
        ...
        <div class="beautify-mobile dp-nonePC dp-block">
            <div class="beautify-container grid wide">
                <div class="beautify row">
                    <div class="beautify--program col-12">
                        <div class="beautify--program__category">
                            <ul class="beautify--program__category--list d-flex">
                                <li class="beautify--program__category--list-item">
                                    <a href="" class="beautify--program__category--list-item-link active">tin tức
                                        mới
                                        nhất</a>
                                </li>
                                <li class="beautify--program__category--list-item">
                    ...
                    <div class="beautify-program col l-9">
                        <div class="beautify-program-list row">
                            <div class="beautify-program-list__item col-12">
                                <div class="beautify-program-list__item--image image-pseudo--tips">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/detailing/img2.png" alt=""
                                         class="beautify-program-list__item--image--product">
                                </div>
                                <div class="beautify-program-list__item--text">
                                    <h2 class="beautify-program-list__item--text--title">10 cách làm đẹp tại nhà
                                        hiệu
                                        quả</h2>
                                    <p class="beautify-program-list__item--text--desc">
                                        Làn da trắng sáng, mịn màng, căng tràn sức sống là niềm mơ ước của mọi cô
                                        gái. Tuy nhiên, không phải ai cũng biết cách chăm sóc da mặt sao cho đúng để
                                        có thể sở hữu làn da tươi trẻ, hồng hào. Dưới đây là những cách chăm sóc và
                                        dưỡng da hiệu quả tại nhà, các bạn có thể tham khảo, áp dụng.
                                    </p>
                            ...
                            <div class="beautify-program-list__item col-12">
                                <div class="beautify-program-list__item--image image-pseudo--tips">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/mobile/imgTip2.png" alt=""
                                         class="beautify-program-list__item--image--product">
                                </div>
                                <div class="beautify-program-list__item--text">
                                    <h2 class="beautify-program-list__item--text--title">Khai trương SHYNH spa chi
                                        nhánh
                                        quận 2</h2>
                                    <p class="beautify-program-list__item--text--desc">
                                        Làn da trắng sáng, mịn màng, căng tràn sức sống là niềm mơ ước của mọi cô
                            ...
                            <div class="beautify-program-list__item col-12">
                                <div class="beautify-program-list__item--image ">
                                    <img src="<?php bloginfo('template_directory'); ?>/images/mobile/imgTip3.png" alt=""
                                         class="beautify-program-list__item--image--product">
                                </div>
                                <div class="beautify-program-list__item--text">
                                    <h2 class="beautify-program-list__item--text--title">ĐĂNG KÝ THÀNH VIÊN VIP CƠ
                                        HỘI
                                        TRÚNG XE SH</h2>
                                    <p class="beautify-program-list__item--text--desc">
                                        Làn da trắng sáng, mịn màng, căng tràn sức sống là niềm mơ ước của mọi cô
                        ...
                        <div class="product-pagination">
                            <ul class="product-pagination-list d-flex">
                                <div class="product-pagination-prev">
                                    <button class="product-pagination-prev__btn">
                                        <img src="<?php bloginfo('template_directory'); ?>/images/mobile/arrowWhite.png" alt="">
                                    </button>
                                </div>
                                <li class="product-pagination-list__item active-white">
                                    <a href="" class="product-pagination-list__item--link">1</a>
